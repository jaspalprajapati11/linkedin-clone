...
const SidebarNetwork = () => {
    return (
        <div className='flex flex-col items-center mt-5'>
            <div>
                <div className="relative flex w-72 flex-col overflow-hidden rounded-xl bg-white bg-clip-border shadow-md">
                    <div className='flex h-16 ml-5 items-center border-b'>
                        <p className='text-md font-semibold'>Manage my network</p>
                        <RiArrowDropDownLine size={28} className='ml-16 mt-1' />
                    </div>
                </div>
            </div>
            <div className='flex flex-col items-center mt-5'>
